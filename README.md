...
- [1] **Kaggle Dataset - Sales Data**  
   Bhosale, S. *Online Sales Dataset*. Retrieved from [Kaggle Online Sales data](kaggle.com/datasets/samruddhi4040/online-sales-data).
